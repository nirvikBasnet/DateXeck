...
public class ScannerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        //here we can receive rawResult (the text EAN13 read by the camera )
        resultTextView.setText(rawResult.getText());
        // here do something after reading the EAN13, so call an activity to input details, or find a product etc.
        // use intents to call another activity.

        //do not forget that once you have finished input all data related to this barcode, call :
        //scannerView.startCamera();
        // to activate the camera and read another barcode.
    }
}
